...
import {
  OrganizationId,
  CurrentUser,
} from "../../common/decorators/organization.decorator";
...
export class CustomersController {
  ...
  findAll(
    ...
    const includeDeletedFlag = includeDeleted.toLowerCase() === "true";

    if (includeDeletedFlag && user?.role !== "ADMIN") {
      throw new ForbiddenException("Only ADMIN can view deleted customers");
    }
